defmodule Jidoka.Subagent.Definition do
  ...
  @spec agent_name(module()) :: {:ok, Jidoka.Subagent.name()} | {:error, String.t()}
  ...
  @spec subagent_names([Jidoka.Subagent.t()]) ::
          {:ok, [Jidoka.Subagent.name()]} | {:error, String.t()}
  ...
  @spec new(module(), keyword()) :: {:ok, Jidoka.Subagent.t()} | {:error, String.t()}
  ...
  @spec normalize_available_subagents([module()] | %{required(Jidoka.Subagent.name()) => module()}) ::
          {:ok, Jidoka.Subagent.registry()} | {:error, String.t()}
  ...
  @spec resolve_subagent_name(Jidoka.Subagent.name(), Jidoka.Subagent.registry()) ::
  ...
  @spec normalize_target(term()) :: {:ok, Jidoka.Subagent.target()} | {:error, String.t()}
  ...
  @spec normalize_forward_context(term()) ::
          {:ok, Jidoka.Subagent.forward_context()} | {:error, String.t()}
  ...
  @spec normalize_result(term()) :: {:ok, Jidoka.Subagent.result_mode()} | {:error, String.t()}
