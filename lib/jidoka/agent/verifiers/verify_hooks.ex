defmodule Jidoka.Agent.Verifiers.VerifyHooks do
  @moduledoc false
    ...
    |> Enum.reduce_while({:ok, default_seen()}, fn
      hook_ref, {:ok, seen} ->
        ...
        cond do
          ...
          true ->
            case Jidoka.Hooks.validate_dsl_hook_ref(stage, hook_ref.hook) do
              :ok ->
  ...
  defp stage_for(%Jidoka.Agent.Dsl.BeforeTurnHook{}), do: :before_turn
  defp stage_for(%Jidoka.Agent.Dsl.AfterTurnHook{}), do: :after_turn
  defp stage_for(%Jidoka.Agent.Dsl.InterruptHook{}), do: :on_interrupt

  defp hook_entity?(%Jidoka.Agent.Dsl.BeforeTurnHook{}), do: true
  defp hook_entity?(%Jidoka.Agent.Dsl.AfterTurnHook{}), do: true
  defp hook_entity?(%Jidoka.Agent.Dsl.InterruptHook{}), do: true
