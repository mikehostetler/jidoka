defmodule Moto.Agent.Verifiers.VerifyGuardrails do
    ...
    |> Enum.reduce_while({:ok, default_seen()}, fn
      guardrail_ref, {:ok, seen} ->
        ...
        cond do
          ...
          true ->
            case Moto.Guardrails.validate_dsl_guardrail_ref(stage, guardrail_ref.guardrail) do
              :ok ->
  ...
  defp guardrail_entity?(%Moto.Agent.Dsl.InputGuardrail{}), do: true
  defp guardrail_entity?(%Moto.Agent.Dsl.OutputGuardrail{}), do: true
  defp guardrail_entity?(%Moto.Agent.Dsl.ToolGuardrail{}), do: true
