defmodule Bagu.Agent.Verifiers.VerifyGuardrails do
  @moduledoc false
    ...
    |> Enum.reduce_while({:ok, default_seen()}, fn
      guardrail_ref, {:ok, seen} ->
        ...
        cond do
          ...
          true ->
            case Bagu.Guardrails.validate_dsl_guardrail_ref(stage, guardrail_ref.guardrail) do
              :ok ->
  ...
  defp stage_for(%Bagu.Agent.Dsl.InputGuardrail{}), do: :input
  defp stage_for(%Bagu.Agent.Dsl.OutputGuardrail{}), do: :output
  defp stage_for(%Bagu.Agent.Dsl.ToolGuardrail{}), do: :tool

  defp guardrail_entity?(%Bagu.Agent.Dsl.InputGuardrail{}), do: true
  defp guardrail_entity?(%Bagu.Agent.Dsl.OutputGuardrail{}), do: true
  defp guardrail_entity?(%Bagu.Agent.Dsl.ToolGuardrail{}), do: true
