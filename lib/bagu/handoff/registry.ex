defmodule Bagu.Handoff.Registry do
  @moduledoc false
  ...
  @doc false
  @spec put_owner(String.t(), Bagu.Handoff.t()) :: :ok
  def put_owner(conversation_id, %Bagu.Handoff{} = handoff) when is_binary(conversation_id) do
  ...
  def handle_call({:put_owner, conversation_id, %Bagu.Handoff{} = handoff}, _from, state) do
    owner = %{
