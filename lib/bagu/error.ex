defmodule Bagu.Error do
  @moduledoc """
  Structured Bagu error helpers.

  Bagu uses Splode-backed errors for validation, configuration, and execution
  ...
  defmodule Internal do
    ...
    defmodule UnknownError do
      ...
      defp unknown_message(nil), do: "Unknown Bagu error"
  ...
  defmodule ValidationError do
    ...
    def exception(opts) do
      ...
      opts
      |> Keyword.put_new(:message, "Invalid Bagu input")
      |> Keyword.put_new(:details, %{})
      |> super()
    end
  end
  ...
  defmodule ConfigError do
    @moduledoc "Invalid Bagu configuration error."
    ...
    def exception(opts) do
      ...
      opts
      |> Keyword.put_new(:message, "Invalid Bagu configuration")
      |> Keyword.put_new(:details, %{})
      |> super()
    end
  end
  ...
  defmodule ExecutionError do
    @moduledoc "Bagu runtime execution error."
    ...
    def exception(opts) do
      ...
      opts
      |> Keyword.put_new(:message, "Bagu execution failed")
      |> Keyword.put_new(:details, %{})
      |> super()
    end
  end
  ...
  @doc """
  Builds a validation error with a consistent Bagu shape.
  """
  ...
  @doc """
  Builds a configuration error with a consistent Bagu shape.
  """
  ...
  @doc """
  Builds a runtime execution error with a consistent Bagu shape.
  """
  ...
  defp format_error_class(errors) do
    ...
    |> Enum.sort()
    |> case do
      [] -> "Bagu operation failed."
      [message] -> message
      messages -> "Multiple Bagu errors:\n" <> Enum.map_join(messages, "\n", &"- #{&1}")
    end
  end
