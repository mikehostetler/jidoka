defmodule Bagu.Demo do
  @moduledoc false

  alias Bagu.Demo.Loader

  @demos %{
    "chat" => %{loader: :chat, module: Bagu.Examples.Chat.Demo},
    "imported" => %{loader: :chat, module: Bagu.Examples.Chat.ImportedDemo},
    "workflow" => %{loader: :workflow, module: Bagu.Examples.Workflow.Demo},
    "support" => %{loader: :support, module: Bagu.Examples.Support.Demo},
    "orchestrator" => %{loader: :orchestrator, module: Bagu.Examples.Orchestrator.Demo},
    "kitchen_sink" => %{loader: :kitchen_sink, module: Bagu.Examples.KitchenSink.Demo}
  }
