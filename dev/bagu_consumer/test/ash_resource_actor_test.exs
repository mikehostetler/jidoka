defmodule BaguConsumer.AshResourceActorTest do
  use ExUnit.Case, async: false

  alias BaguConsumer.Accounts
  alias BaguConsumer.Accounts.SecureNote
  alias BaguConsumer.SupportNoteAgent
  ...
  test "Bagu ash_resource agents do not supply a default actor" do
  ...
  defp assert_missing_actor(fun) do
    assert {:error, %Bagu.Error.ValidationError{} = error} = fun.()
