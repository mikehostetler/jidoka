...
- Phoenix LiveView integration with a thread-backed Jidoka agent view projection

## Phoenix LiveView Spike

The root LiveView demonstrates the proposed Jidoka/Phoenix boundary:

- `JidokaConsumerWeb.SupportChatView` starts/reuses a Jidoka agent and defines the
