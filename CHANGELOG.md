...
All notable changes to Bagu will be documented in this file.
...
- Spark-backed `Bagu.Agent` DSL for chat-oriented Jido/Jido.AI agents.
- Bagu-native tools, plugins, hooks, guardrails, runtime context, memory, skills,
...
- Bagu is experimental and should not be treated as a stable public package.
