defmodule BaguTest.WorkflowSpike.AddAmount do
  @moduledoc false
...
defmodule BaguTest.WorkflowSpike.DoubleValue do
  @moduledoc false
...
defmodule BaguTest.WorkflowSpike.Fail do
  @moduledoc false
...
defmodule BaguTest.WorkflowSpike do
  @moduledoc false

  alias Jido.Runic.ActionNode
  alias BaguTest.WorkflowSpike.{AddAmount, DoubleValue, Fail}
  ...
  def pipeline_workflow do
    ...
    Workflow.new(name: :bagu_workflow_spike_pipeline)
  ...
  def failing_workflow do
    ...
    Workflow.new(name: :bagu_workflow_spike_failure)
...
defmodule BaguTest.WorkflowSpike.AgentServerAgent do
  @moduledoc false

  use Jido.Agent,
    name: "bagu_workflow_spike_agent",
  ...
  def build_workflow, do: BaguTest.WorkflowSpike.pipeline_workflow()
end
