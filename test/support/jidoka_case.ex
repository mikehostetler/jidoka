defmodule JidokaTest.Support.Case do
  ...
  using opts do
    ...
    quote do
      ...
      import JidokaTest.Support.Helpers

      alias Jidoka.ImportedAgent
      alias JidokaTest.Support.{Accounts, AshResourceAgent, User}
    end
  end
end

defmodule JidokaTest.Support.Helpers do
