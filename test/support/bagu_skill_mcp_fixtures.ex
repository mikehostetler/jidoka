defmodule BaguTest.ModuleMathSkill do
  use Jido.AI.Skill,
    ...
    actions: [BaguTest.MultiplyNumbers],
    body: """
    # Module Math Skill
...
defmodule BaguTest.SkillAgent do
  use Bagu.Agent
  ...
  capabilities do
    skill BaguTest.ModuleMathSkill
  end
end

defmodule BaguTest.RuntimeSkillAgent do
  use Bagu.Agent
...
defmodule BaguTest.MCPAgent do
  use Bagu.Agent
...
defmodule BaguTest.LocalFSMCPAgent do
  use Bagu.Agent
...
defmodule BaguTest.InlineMCPAgent do
  use Bagu.Agent
...
defmodule BaguTest.FakeMCPSync do
...
defmodule BaguTest.FailingMCPSync do
  def run(params, _context) do
    send(self(), {:mcp_sync_called, params})
